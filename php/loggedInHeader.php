    ...
    <section class="header-section">
      ...
      <div id='top-menu'>
        <ul class="top-menu">
          ...
          <li><a href="?page=products_drinks"><img class='menu-logo' src="img/coffee-cup.svg" /> Drinks</a></li>
          <li><a href="?page=products_vegetables"><img class='menu-logo' src="img/broccoli.svg" /> Vegetables</a></li>
          <li><a href="?page=products_dairy"><img class='menu-logo' src="img/piece-of-cheese.svg" /> Dairy</a></li>
          <li><a href="?page=contact"><img class='menu-logo' src="img/contact.svg" /> Contact</a></li>
        </ul>
      </div>
      <!-- / Navbar -->
<!-- login -->
